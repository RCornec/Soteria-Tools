...
Public Class SoteriaDatabaseSettings
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        DAL.Soteria.SaveConnectionString(tbServer.Text, tbPort.Text, tbDBName.Text, tbUser.Text, tbpw.Text)
    ...
    Private Sub displayInfos()
        ...
        DAL.Soteria.LoadConnectionString(server, port, dbname, user, pw)
